...
namespace Watermelon
{
    public class LevelController : MonoBehaviour
    {
        ...
        public void LoadLevel(int levelId)
        {
            ...
            if (cameraData != null)
            {
                CinemachineCameraController.ActiveVirtualCamera.SetFollowOffset(cameraData.FollowOffset);
                CinemachineCameraController.ActiveVirtualCamera.SetTrackedObjectOffset(cameraData.ObjectOffset);
                CinemachineCameraController.ActiveVirtualCamera.SetFov(cameraData.FOV);
            }
            else
            {

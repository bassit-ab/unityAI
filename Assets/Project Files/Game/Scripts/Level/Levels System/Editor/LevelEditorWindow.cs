...
namespace Watermelon.LevelEditor
{
    public class LevelEditorWindow : LevelEditorBase
    {
        ...
        protected override void InitializeVariables()
        {
            ...
            AssemblyReloadEvents.beforeAssemblyReload += SaveLevelIfPosssible;
        ...
        private SerializedProperty GetItemTypeProperty(ItemType type)
        {
            switch (type)
            {
                case ItemType.Gates: return gatesDataProperty;
                case ItemType.Boosters: return boostersDataProperty;
                case ItemType.Obstacles: return obstaclesDataProperty;
                case ItemType.Enemies: return enemiesDataProperty;
                case ItemType.Road: return roadPrefabsProperty;
                case ItemType.Finish: return finishPrefabsProperty;
                case ItemType.Environment: return environmentPrefabsProperty;
                default:

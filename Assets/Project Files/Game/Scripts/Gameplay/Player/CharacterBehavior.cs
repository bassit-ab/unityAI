...
namespace Watermelon
{
    public class CharacterBehavior : MonoBehaviour, IWeaponPlacementReceiver
    {
        ...
        {
            if (GunBehavior != null) GunBehavior.RecalculateBulletRange(modifiers, minRange);
        }
        ...
        {
            if (Health.MaxHealth == 0) Health.Initialise(1);
            Health.Restore();
        }
        ...
        {
            if (moneyPickupParticle != null) moneyPickupParticle.Play();
        }
    }
